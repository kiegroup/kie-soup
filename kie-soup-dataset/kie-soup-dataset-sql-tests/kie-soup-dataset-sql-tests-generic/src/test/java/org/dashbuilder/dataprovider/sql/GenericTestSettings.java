...
public class GenericTestSettings extends DatabaseTestSettings {
    
    protected static final String DATASOURCE_PROPERTIES = "/datasource.properties";
    
    private static final Logger log = LoggerFactory.getLogger(GenericTestSettings.class);
    
    private static Properties defaultProperties = null;
    
    private static Properties props = getDatasourceProperties();
    
    public GenericTestSettings() {
    }
    ...
    public static Properties getDatasourceProperties() {
        ...
        InputStream propsInputStream = GenericTestSettings.class.getResourceAsStream(DATASOURCE_PROPERTIES);
